...
public class AddUser extends HAFormFactory{
	...
	public void executeUI() {
		...
		linearLayoutRoot.addView(getView("User PIN", new EditText(getApplicationContext())));
		linearLayoutRoot.addView(getView("Re-Type User PIN", new EditText(getApplicationContext())));
