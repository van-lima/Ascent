...
public class Water extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initControl();
		setTitle(getString(R.string.water_costs));
		setButtonListener();
	}
	...
	private class MyPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(View collection, int position) {
			...
			switch (position) {
			case 0:
				resId = R.layout.water_manage_page1_activity;
				view = inflater.inflate(resId, null);

				break;
			case 1:
				resId = R.layout.water_manage_page2_activity;
				view = inflater.inflate(resId, null);
