...
public class ControlMoreRowSecond extends LinearLayout{
	
	public ControlMoreRowSecond(Context context) {
		super(context);
	}

	public ControlMoreRowSecond(Context context, final int width, final int height) {
		super(context);
		...
		LinearLayout titleFirst = getTitleViewRightBorder("Downstair", R.drawable.detail, height, width/3);
		...
		LinearLayout titleSecond = getTitleViewRightBorder("Printer 1", R.drawable.detail, height, width/3);
		linearLayoutColumnSecond.addView(titleSecond);
		linearLayoutColumnSecond.addView(new ViewComponent(context, height, R.drawable.printer_off, R.drawable.printer_on));
		...
		LinearLayout titleSecondThird = getTitleView("Printer 2", R.drawable.detail, width/3);
