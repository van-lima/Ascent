...
public class SecurityMoreRowSecond extends LinearLayout{
	
	public SecurityMoreRowSecond(Context context) {
		super(context);
	}

	public SecurityMoreRowSecond(Context context, final int width, final int height) {
		super(context);
		...
		LinearLayout titleFirst = getTitleViewRightBorder("Light Sensor", R.drawable.detail, height, width/3);
		linearLayoutColumnFirst.addView(titleFirst);
		linearLayoutColumnFirst.addView(new ViewComponent(context, height, R.drawable.lights_off, R.drawable.lights_on, true));
		...
		LinearLayout titleSecond = getTitleViewRightBorder("Power Socket", R.drawable.detail, height, width/3);
		linearLayoutColumnSecond.addView(titleSecond);
		linearLayoutColumnSecond.addView(new ViewComponent(context, height, R.drawable.power_off, R.drawable.power_on));
		...
		LinearLayout titleSecondThird = getTitleView("Printer", R.drawable.detail, width/3);
		linearLayoutColumnThird.addView(titleSecondThird);
		linearLayoutColumnThird.addView(new ViewComponent(context, height, R.drawable.printer_off, R.drawable.printer_on));
